...
import 'package:e_commerce_bloc/presentation/products/pages/product_details_page.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => AppNavigator.push(
        context,
        ProductDetailsPage(productEntity: productEntity),
      ),
      child: Container(
        width: 180,
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage(
                      'assets/products/${productEntity.title}.png',
                    ),
                  ),
