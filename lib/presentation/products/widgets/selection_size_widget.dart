...
class SelectionSizeWidget extends StatelessWidget {
  const SelectionSizeWidget({super.key});
            ...
            child: ListView.separated(
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () {
                    context.read<SelectSizeCubit>().selectSize(index);
                    Navigator.pop(context);
                  },
                  child: Container(
                    height: 60.0,
                    ...
                    decoration: BoxDecoration(
                      ...
                      color:
                          context.read<SelectSizeCubit>().selectedSize ==
                              productSizes[index]
                          ? AppColors.primary
